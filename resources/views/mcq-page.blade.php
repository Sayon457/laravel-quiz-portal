...
<body>
    ...
    <div class="bg-gray-100 flex flex-col min-h-screen items-center pt-5">
        <h1 class="text-3xl text-center text-green-800 mb-6 font-semibold">QUIZ</h1>
        <h2 class="text-2xl text-center text-green-800 mb-6 font-semibold">Question No.2</h2>
